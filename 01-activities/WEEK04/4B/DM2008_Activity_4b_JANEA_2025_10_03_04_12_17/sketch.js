...
function setup() {
  ...
  for (let i = 0; i < NUM_START; i++) {
    ...
    //let col = random((200,255), random(51, 90),random (20, 133));
...
//     }
    ...
    if (this.sz += sin(frameCount * 0.10) * 0.2){
  ...
  show() {
    ...
    fill(random(50, 255) + (this.h % 200), 120, 200, this.a);
    ellipse(this.x, this.y, this.sz*8);
  }
  changeColor(){
    fill(70, random())
    ellipse(this.x, this.y, this.sz/3)
  }
